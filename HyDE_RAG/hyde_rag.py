...
def query_for_evaluation(question: str) -> dict:
    ...
    # Medir tiempo de ejecución y tracking completo
    import time
    from langchain_community.callbacks import get_openai_callback
    
    start_time = time.time()
    
    # process_hyde_query ya tiene tracking interno, no necesitamos callback externo
    ...
    return {
        ...
        "contexts": result["contexts"],  # Ya incluido en process_hyde_query
        "metadata": {
